...
MainGame.Level2.prototype = {
    ...
    create: function() {
        ...
        this.background = this.game.add.tileSprite(0, 0, 1024, 1024, "L2BG");
        ...
        this.spikeLayer = this.game.add.tilemapLayer(0, 0, 800, 600, this.tileset, this.map, 2);
        ...
        this.bunnySprite = this.game.add.sprite(10, 500, 'alien');
