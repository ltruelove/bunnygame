...
MainGame.Player.prototype.animatePlayer = function (){
    ...
    this.animations.add('walk',this.walkFrames);

    this.animations.add('jump',["p3_jump"],this.animFrameCount,true);
    this.animations.add('stand',["p3_stand"],this.animFrameCount,true);
    this.animations.add('hurt',["p3_hurt"],this.animFrameCount,true);
...
MainGame.Player.prototype.updatePlayer = function() {
    if(this.hurtCount < 1){
        ...
        if(this.body.velocity.x == 0){
            //this.animations.stop('walk',this.animFrameCount,true);
            this.animations.play('walk',this.animFrameCount,true);
        }
